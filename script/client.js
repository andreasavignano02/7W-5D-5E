...
//     let moviedisney = await fetch ('https://api.disneyapi.dev/character')
...
//         contenitorepg.innerHTML += `<div class="stili"><img src="${arraymovies[i].imageUrl}" alt="disney"> ${arraymovies[i].name}</div>`
//     }
// }
